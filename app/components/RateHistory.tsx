...
const RateHistory = () => {
  // Mock data for May 2025
   const rateHistory = [
    { date: '2025-05-25', rate: 140 }, // Current rate
    { date: '2025-05-24', rate: 139 },
    { date: '2025-05-23', rate: 138 },
    { date: '2025-05-22', rate: 139 },
    { date: '2025-05-21', rate: 140 },
    { date: '2025-05-20', rate: 139 },
  ]
